...
Answer: I think that plots 1.4, 1.7, 1.9, and 1.11 are the most informative. Basically, plots that give more information (without looking too crazy) are more desirable over plots that give less information. From these plots, some major trends I see in the data are: for each region, as CPI increases, HPI also increases; Western European countries have a higher HDI than other regions, while Sub-Saharan African countries have a lower relative HDI; some Asia Pacific countries have a high HDI while other Asia Pacific countries have a low HDI; Eastern European and Central Asian countries have a relatively high/moderate HDI with a low CPI... etc
